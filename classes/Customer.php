...
class Customer extends User {
    ...
    public function bookEvent(PDO $db, int $eventId, int $numTickets): int {
        try {
            ...
            return "<p class='error'>حدث خطأ أثناء حجز الفعالية: " . $e->getMessage() . "</p>";
        }
    }
    ...
    public function cancelBooking(PDO $db, int $bookingId): string {
        try {
            ...
            return "<p class='error'>حدث خطأ أثناء محاولة إلغاء الحجز: " . $e->getMessage() . "</p>";
        }
    }
    ...
    public function viewBookings(PDO $db): array {
        try {
            ...
            echo "<p class='error'>حدث خطأ أثناء عرض الحجوزات: " . $e->getMessage() . "</p>";
            return [];
        }
    }
}
